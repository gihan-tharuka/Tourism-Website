...
export function TourDetailCTA({ tour }: TourDetailCTAProps) {
  ...
  return (
    <section className="py-14">
      <div className="mx-auto max-w-7xl rounded-[3rem] border border-amber-300/15 bg-gradient-to-r from-slate-950/95 via-slate-900/95 to-slate-950/95 p-8 shadow-[0_30px_90px_rgba(251,191,36,0.18)]">
